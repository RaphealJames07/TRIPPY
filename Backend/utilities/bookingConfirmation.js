            ...
            <tr>
                <td>
                    <div style="padding: 0 2.5em; text-align: center;">
                        ...
                        <p>Number of Rooms Booked: ${numRooms}</p>
                        <p>Flight Depature : ${flightDepature}</p>
                        <p>Flight Arrival: ${flightArrival}</p>
                        <p>Name(s) of travelers: ${travelers}</p>
                        <p>Return Flight Depature:${returnFlightDepature}</p>
                        <p>Reture Flight Arrival: ${returnFlightArrival} </p>
                        <p>Car Rental Details: ${carRentalDetails}</p>
                        <p>Booked Tour Details: ${tourDetails}</p>
